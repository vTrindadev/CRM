...
if ($_SESSION['acesso'] !== 'Partes e Peças') {
...
$sql = "SELECT * FROM demandas WHERE TipoProposta = 'Partes e Peças'";
...
<body>
  ...
  <div id="menu">
    ...
    <div class="opt-menu">
      <a href="partesepeças.php" class="btn-menu activo"><h3>Partes e Peças</h3></a>
