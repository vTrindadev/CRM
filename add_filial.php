...
<body>
  ...
  <div class="container">
    <form id="detalhesForm" method="POST">
      ...
      <div class="form-section">
        ...
        <div class="form-group"><label for="pais">País:</label><input type="text" id="pais" name="pais" required readonly></div>
      </div>
  ...
  <script>
    // Passando o valor da sessão PHP para a variável JavaScript
    var codigoClienteSession = "<?php echo $codigoClienteSession; ?>";

    // Preenchendo o campo com o valor da variável
    if (codigoClienteSession) {
